...
import 'package:inventory/product/productAddItem.dart';

class Product extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(title: 'Flutter Tutorial', home: Main());
  }
}
...
class Main extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Product', style: const TextStyle(fontSize: 25, fontWeight: FontWeight.bold)),
      ),
      body: Padding(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: <Widget>[
          ...
          Align(
            ...
            child: RaisedButton.icon(
              color: Colors.green,
              label: Text('New Product', style: const TextStyle(fontSize: 15)),
              icon: Icon(Icons.add),
